...
<template>
    <div class="app-container calendar-list-container">
        ...
        <el-table :data="list" style="width: 100%">
                ...
                <el-table-column prop="organizationId" label="组织编号" width="160"></el-table-column>
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form class="small-space" :model="temp" label-position="left" label-width="70px" style='width: 400px; margin-left:50px;'>
                    ...
                    <el-form-item label="组织编号">
                        <el-input v-model="temp.organizationId"></el-input>
                    </el-form-item>
...
<script>
    import { fetchList, deleteUpmsUserOrganization, insertUpmsUserOrganization, updateUpmsUserOrganization} from 'api/upmsuserorganization';

    export default {
        name: 'UpmsUserOrganization_INDEX',
        data() {
            return {
                list: null,
                total: null,
        ...
        methods: {
            ...
            handleCreate () {
                insertUpmsUserOrganization (this.temp).then(response => {
            ...
            // update() {
            handleUpdate () {
                updateUpmsUserOrganization (this.temp).then(response => {
                    this.dialogFormVisible = false;
                    this.$notify({
            ...
            handleDelete(row) {
                this.$confirm('确认删除用户 [ ' + row.id +' ]？')
                    .then(_ => {
                        ...
                        deleteUpmsUserOrganization (postData).then(response => {
                            this.$notify({
