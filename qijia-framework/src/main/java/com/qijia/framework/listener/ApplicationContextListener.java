package com.qijia.framework.listener;
...
//            Map<String, Object> baseServices = contextRefreshedEvent.getApplicationContext().getBeansWithAnnotation(IBaseService.class);
