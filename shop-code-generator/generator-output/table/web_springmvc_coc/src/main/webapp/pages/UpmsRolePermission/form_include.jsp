...
<%@ include file="/commons/taglibs.jsp" %>
	...
	<tr>	
		...
		<td>
		<form:input path="upmsRolePermission.roleId" id="roleId" cssClass="required validate-integer max-value-2147483647" maxlength="10" />
	...
	<tr>	
		...
		<td>
		<form:input path="upmsRolePermission.permissionId" id="permissionId" cssClass="required validate-integer max-value-2147483647" maxlength="10" />
	...
	<tr>	
		...
		<td>
		<form:input path="upmsRolePermission.createTime" id="createTime" cssClass="validate-integer " maxlength="19" />
	...
	<tr>	
		...
		<td>
		<form:input path="upmsRolePermission.updateTime" id="updateTime" cssClass="validate-integer " maxlength="19" />
