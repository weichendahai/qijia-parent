...
<template>
    <div class="app-container calendar-list-container">
        ...
        <el-table :data="list" style="width: 100%">
                ...
                <el-table-column prop="name" label="组织名称" width="160"></el-table-column>
                <el-table-column prop="description" label="组织描述" width="160"></el-table-column>
...
<script>
    import { fetchList, deleteUpmsOrganization, insertUpmsOrganization, updateUpmsOrganization} from 'api/upmsorganization';

    export default {
        name: 'UpmsOrganization_INDEX',
        data() {
            return {
                list: null,
                total: null,
        ...
        methods: {
            ...
            handleCreate () {
                insertUpmsOrganization (this.temp).then(response => {
            ...
            // update() {
            handleUpdate () {
                updateUpmsOrganization (this.temp).then(response => {
                    this.dialogFormVisible = false;
                    this.$notify({
            ...
            handleDelete(row) {
                this.$confirm('确认删除用户 [ ' + row.id +' ]？')
                    .then(_ => {
                        ...
                        deleteUpmsOrganization (postData).then(response => {
                            this.$notify({
