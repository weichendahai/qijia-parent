...
<template>
    <div class="app-container calendar-list-container">
        ...
        <el-table :data="list" style="width: 100%">
                ...
                <el-table-column prop="roleId" label="角色编号" width="160"></el-table-column>
...
<script>
    import { fetchList, deleteUpmsRolePermission, insertUpmsRolePermission, updateUpmsRolePermission} from 'api/upmsrolepermission';

    export default {
        name: 'UpmsRolePermission_INDEX',
        data() {
            return {
                list: null,
                total: null,
        ...
        methods: {
            ...
            handleCreate () {
                insertUpmsRolePermission (this.temp).then(response => {
            ...
            // update() {
            handleUpdate () {
                updateUpmsRolePermission (this.temp).then(response => {
                    this.dialogFormVisible = false;
                    this.$notify({
            ...
            handleDelete(row) {
                this.$confirm('确认删除用户 [ ' + row.id +' ]？')
                    .then(_ => {
                        ...
                        deleteUpmsRolePermission (postData).then(response => {
                            this.$notify({
