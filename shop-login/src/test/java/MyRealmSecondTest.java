 ...
 */
public class MyRealmSecondTest {

	@Test
	public void testMyRealmSecondTest () {

//		1. 获取SecurityManager工厂，此处使用Ini配置恩建初始化SecurityManager
		IniSecurityManagerFactory iniSecurityManagerFactory = new IniSecurityManagerFactory("classpath:shiro-multi-realm.ini");
...
//		7. 退出
	...
	@Test
	public void testMyRealmSecondTest2 () {
