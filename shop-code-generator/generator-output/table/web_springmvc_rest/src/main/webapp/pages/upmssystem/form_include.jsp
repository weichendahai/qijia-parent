...
<%@ include file="/commons/taglibs.jsp" %>
	...
	<tr>	
		...
		<td>
		<form:input path="banner" id="banner" cssClass="" maxlength="150" />
	...
	<tr>	
		...
		<td>
		<form:input path="theme" id="theme" cssClass="" maxlength="50" />
	...
	<tr>	
		...
		<td>
		<form:input path="basepath" id="basepath" cssClass="" maxlength="100" />
	...
	<tr>	
		...
		<td>
		<form:input path="description" id="description" cssClass="" maxlength="300" />
