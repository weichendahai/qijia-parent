...
<%@ include file="/commons/taglibs.jsp" %>
	...
	<tr>	
		...
		<td>
		<form:input path="description" id="description" cssClass="" maxlength="100" />
	...
	<tr>	
		...
		<td>
		<form:input path="username" id="username" cssClass="" maxlength="20" />
	...
	<tr>	
		...
		<td>
		<form:input path="startTime" id="startTime" cssClass="validate-integer " maxlength="19" />
	...
	<tr>	
		...
		<td>
		<form:input path="spendTime" id="spendTime" cssClass="validate-integer max-value-2147483647" maxlength="10" />
	...
	<tr>	
		...
		<td>
		<form:input path="basePath" id="basePath" cssClass="" maxlength="500" />
	...
	<tr>	
		...
		<td>
		<form:input path="uri" id="uri" cssClass="" maxlength="500" />
	...
	<tr>	
		...
		<td>
		<form:input path="url" id="url" cssClass="" maxlength="500" />
	...
	<tr>	
		...
		<td>
		<form:input path="method" id="method" cssClass="" maxlength="10" />
	...
	<tr>	
		...
		<td>
		<form:input path="parameter" id="parameter" cssClass="" maxlength="16777215" />
	...
	<tr>	
		...
		<td>
		<form:input path="userAgent" id="userAgent" cssClass="" maxlength="500" />
	...
	<tr>	
		...
		<td>
		<form:input path="ip" id="ip" cssClass="" maxlength="30" />
	...
	<tr>	
		...
		<td>
		<form:input path="result" id="result" cssClass="" maxlength="16777215" />
	...
	<tr>	
		...
		<td>
		<form:input path="permissions" id="permissions" cssClass="" maxlength="100" />
