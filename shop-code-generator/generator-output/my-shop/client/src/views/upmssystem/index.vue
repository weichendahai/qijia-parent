...
<template>
    <div class="app-container calendar-list-container">
        ...
        <el-table :data="list" style="width: 100%">
                ...
                <el-table-column prop="banner" label="背景" width="160"></el-table-column>
                <el-table-column prop="theme" label="主题" width="160"></el-table-column>
                <el-table-column prop="basepath" label="根目录" width="160"></el-table-column>
                <el-table-column prop="status" label="状态(-1:黑名单,1:正常)" width="160"></el-table-column>
                <el-table-column prop="name" label="系统名称" width="160"></el-table-column>
                <el-table-column prop="title" label="系统标题" width="160"></el-table-column>
                <el-table-column prop="description" label="系统描述" width="160"></el-table-column>
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form class="small-space" :model="temp" label-position="left" label-width="70px" style='width: 400px; margin-left:50px;'>
                    ...
                    <el-form-item label="主题">
                        <el-input v-model="temp.theme"></el-input>
                    </el-form-item>
                    <el-form-item label="根目录">
                        <el-input v-model="temp.basepath"></el-input>
                    </el-form-item>
                    <el-form-item label="状态(-1:黑名单,1:正常)">
...
<script>
    import { fetchList, deleteUpmsSystem, insertUpmsSystem, updateUpmsSystem} from 'api/upmssystem';

    export default {
        name: 'UpmsSystem_INDEX',
        data() {
            return {
                list: null,
                total: null,
                ...
                temp: {
                    ...
                    theme : '', //主题 String
                    basepath : '', //根目录 String
                    status : '', //状态(-1:黑名单,1:正常) Integer
                    name : '', //系统名称 String
                    title : '', //系统标题 String
                    description : '', //系统描述 String
                    orders : '', //排序 Long
        ...
        methods: {
            ...
            handleCreate () {
                insertUpmsSystem (this.temp).then(response => {
            ...
            // update() {
            handleUpdate () {
                updateUpmsSystem (this.temp).then(response => {
                    this.dialogFormVisible = false;
                    this.$notify({
            ...
            handleDelete(row) {
                this.$confirm('确认删除用户 [ ' + row.id +' ]？')
                    .then(_ => {
                        ...
                        deleteUpmsSystem (postData).then(response => {
                            this.$notify({
