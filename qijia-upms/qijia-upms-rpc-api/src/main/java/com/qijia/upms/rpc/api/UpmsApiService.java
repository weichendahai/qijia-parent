...
public interface UpmsApiService {
     ...
     * @return
     */
    List<UpmsSystem> selectUpmsSystemByExample(UpmsSystem upmsSystemExample);
     ...
     * @return
     */
    List<UpmsOrganization> selectUpmsOrganizationByExample(UpmsOrganization upmsOrganizationExample);
