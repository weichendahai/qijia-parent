 ...
 */
public class UpmsSystemManagerTest extends BaseManagerTestCase{

	private UpmsSystemManager manager;
    ...
    protected String[] getDbUnitDataFiles() {
        ...
        return new String[]{"classpath:testdata/common.xml","classpath:testdata/UpmsSystem.xml",
                            "classpath:testdata/UpmsSystem_"+TestMethodContext.getMethodName()+".xml"};
    }
	...
	public static UpmsSystem newUpmsSystem() {
		UpmsSystem obj = new UpmsSystem();
		
	  	obj.setIcon(new String("1"));
	  	obj.setBanner(new String("1"));
	  	obj.setTheme(new String("1"));
