...
<template>
    <div class="app-container calendar-list-container">
        ...
        <el-table :data="list" style="width: 100%">
                ...
                <el-table-column prop="title" label="角色标题" width="160"></el-table-column>
...
<script>
    import { fetchList, deleteUpmsRole, insertUpmsRole, updateUpmsRole} from 'api/upmsrole';
    ...
    export default {
        ...
        methods: {
            ...
            handleCreate () {
                insertUpmsRole (this.temp).then(response => {
            ...
            // update() {
            handleUpdate () {
                updateUpmsRole (this.temp).then(response => {
                    this.dialogFormVisible = false;
                    this.$notify({
            ...
            handleDelete(row) {
                this.$confirm('确认删除用户 [ ' + row.id +' ]？')
                    .then(_ => {
                        ...
                        deleteUpmsRole (postData).then(response => {
                            this.$notify({
