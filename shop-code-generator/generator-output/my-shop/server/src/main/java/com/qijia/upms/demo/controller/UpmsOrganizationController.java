...
@Controller
@RequestMapping("/api/v1/upmsorganization")
public class UpmsOrganizationController extends BaseController {
	...
	/**
	 *
	 * @api {POST} /api/v1/upmsorganization/insert 添加数据
	 * @apiName insert_data
	 * @apiGroup upmsorganization
	 * @apiVersion 1.0.0
	 ...
	 * @apiParam {String} description 组织描述
	...
	@ResponseBody
	private String insert (@RequestBody UpmsOrganizationRequest params) {
		UpmsOrganization upmsOrganization = upmsOrganizationService.assembleUpmsOrganization(params);
		int r = upmsOrganizationService.insert(upmsOrganization);
		String str = callbackSuccess (r);
		return str;
	}

	/**
	 * @api {POST} /api/v1/upmsorganization/delete 删除数据
	 * @apiName delete_data
	 * @apiGroup upmsorganization
	 * @apiVersion 1.0.0
	...
	private String delete (@RequestBody Long id) {
		int r = upmsOrganizationService.delete(id);
		String str = callbackSuccess (r);
		return str;
	}

	/**
	 * @api {POST} /api/v1/upmsorganization/update 修改数据
	 * @apiName update_data
	 * @apiGroup upmsorganization
	 * @apiVersion 1.0.0
	...
	@ResponseBody
	private String update (@RequestBody UpmsOrganizationRequest params) {
		UpmsOrganization upmsOrganization = upmsOrganizationService.assembleUpmsOrganization(params);
		int r = upmsOrganizationService.update(upmsOrganization);
		String str = callbackSuccess (r);
		return str;
	}

	/**
	 * @api {POST} /api/v1/upmsorganization/list 列表数据
	 * @apiName get_data
	 * @apiGroup upmsorganization
	 * @apiVersion 1.0.0
	...
	@ResponseBody
	private String list (@RequestBody UpmsOrganizationRequest params) {
		PageResponse<UpmsOrganizationResponse> upmsOrganizationList = upmsOrganizationService.queryByObject(params);
		String str = callbackSuccess(upmsOrganizationList);
		return str;
	}
}